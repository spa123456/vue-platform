    ...
    <el-container class="right-container">
      <el-header height="60px" class="querycarmessage">
        <div class="header-input">
          <el-input placeholder="请输入储蓄车牌/车主名查询" prefix-icon="el-icon-search" v-model="inputvalue"></el-input>
        </div>
        <div>
          <el-date-picker
            v-model="querytime"
      ...
      <el-main>
        <el-table :data="cartableData" style="width: 100%" stripe border size="mini">
          ...
          <el-table-column label="车主名" prop="date" align="center"></el-table-column>
          <el-table-column label="充值金额" prop="date" align="center"></el-table-column>
          <el-table-column label="充值时间" prop="date" align="center"></el-table-column>
          <el-table-column label="备注" prop="date" align="center"></el-table-column>
          <el-table-column label="余额" prop="date" align="center"></el-table-column>
        </el-table>
      </el-main>
