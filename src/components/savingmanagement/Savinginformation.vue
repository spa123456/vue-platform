      ...
      <el-container class="right-container">
        ...
        <el-main>      
              <el-table :data="cartableData" style="width: 100%" stripe border size="mini">
                ...
                <el-table-column label="联系人" prop="date" align="center"></el-table-column>
                <el-table-column label="电话" prop="date" align="center"></el-table-column>
                <el-table-column label="账号余额" prop="date" align="center"></el-table-column>
                <el-table-column label="备注" prop="date" align="center"></el-table-column>
                <el-table-column label="操作" align="center" width="350px">
                  <template slot-scope="scope">
                    <el-button size="mini" type="warning " @click="writeplate(scope.row)">充值</el-button>
                    <el-button size="mini" type="success " @click="writeplate(scope.row)">查看详情</el-button>
