    ...
    <el-container class="right-container">
      <el-header height="60px" class="querycarmessage">
        <div class="header-input">
          <el-input placeholder="请输入操作人员/操作内容查询" prefix-icon="el-icon-search" v-model="inputvalue"></el-input>
        </div>
        <div>
          <el-date-picker
            v-model="querytime"
      ...
      <el-main>
        <el-table :data="cartableData" style="width: 100%" stripe class="nonly-secect" border>
          <el-table-column label="付款方式" prop="date" align="center" :render-header="renderHeaderone"></el-table-column>
          <el-table-column label="交易类别" prop="date" align="center" :render-header="renderHeadertwo"></el-table-column>
          <el-table-column label="操作时间" prop="date" align="center"></el-table-column>
          <el-table-column label="操作内容" prop="date" align="center"></el-table-column>
          <el-table-column label="操作者" prop="date" align="center"></el-table-column>
          <el-table-column label="查看详情" prop="date" align="center">
            <template slot-scope="scope">
              <el-button @click="refund(scope.row)" type="primary" size="mini">详情</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-main>
