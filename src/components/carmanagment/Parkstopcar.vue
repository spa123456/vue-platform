        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="全部" name="first">
            <el-table :data="cartableData" style="width: 100%" stripe border>
              ...
              <el-table-column label="临停类型" prop="date" align="center"></el-table-column>
          ...
          <el-tab-pane label="SUV" name="second">SUV</el-tab-pane>
          <el-tab-pane label="轿车" name="third">轿车</el-tab-pane>
